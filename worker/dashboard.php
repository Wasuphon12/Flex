...
<main class="dashboard">
    ...
    <div class="dashboard-grid">
        <section class="panel" id="applications">
            <h2>งานที่สมัคร <span class="count"><?= count($apps) ?></span></h2><?php foreach ($apps as $app): ?><div class="application">
                    <div><b><?= e($app['title']) ?></b>
                ...
                </div><?php endforeach ?><?php if (!$apps): ?><div class="empty">ยังไม่มีงานที่สมัคร <a href="<?= BASE_URL ?>/jobs.php">เริ่มค้นหางาน</a></div><?php endif ?>
        </section>
    </div>
