...
$documentStmt = $pdo->prepare('SELECT document_file_path, document_status, review_note, submitted_at, reviewed_at FROM employer_documents WHERE employer_user_id=? ORDER BY submitted_at DESC LIMIT 1');
        ...
        <div class="col-lg-5">
            <section class="card border-0 shadow-sm h-100"><div class="card-body p-4">
                ...
                <?php if ($document): ?>
                    ...
                    <a class="btn btn-sm btn-outline-primary" target="_blank" rel="noopener" href="<?= BASE_URL . '/' . e($document['document_file_path']) ?>">เปิดเอกสาร</a>
                <?php else: ?>
