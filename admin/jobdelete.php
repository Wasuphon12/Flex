        ...
        <div class="col-lg-7">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form method="post"><input type="hidden" name="job_id" value="<?= $jobId ?>"><label class="form-label" for="reason">เหตุผลในการลบ</label><textarea id="reason" class="form-control" name="reason" rows="4" required placeholder="ระบุเหตุผลเพื่อแจ้งผู้ว่าจ้าง"></textarea>
