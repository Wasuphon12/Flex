            ...
            <?php if ($currentUser): ?>
                <details class="notification-menu">
                    ...
                    <div class="notification-panel">
                        ...
                        <?php if ($notifications): ?><form class="notification-clear" method="post" action="<?= BASE_URL ?>/notification-clear.php"><input type="hidden" name="return_path" value="<?= e(ltrim(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH) ?: '', '/')) ?>"><button type="submit">ล้างการแจ้งเตือนทั้งหมด</button></form><?php endif; ?>
                    </div>
                </details>
